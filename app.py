...
with tab4:
    ...
    st.markdown("""
    <div style="background-color: #e0f2fe; padding: 15px; border-radius: 10px; border-right: 5px solid #0284c7; margin-bottom: 20px;">
        <h3 style="color: #0369a1; font-family: 'Cairo', sans-serif; margin: 0;">🎬 رسالة ترحيبية وشرح لآلية العمل</h3>
    </div>
    """, unsafe_allow_html=True)
    
    # الكود الآمن لعرض الفيديو إذا كان موجوداً
    if os.path.exists("welcome.mp4"):
        st.video("welcome.mp4")
    else:
        st.info("📌 جاري تجهيز ورفع الفيديو الترحيبي الخاص بالمنصة قريباً...")

    st.markdown("<hr>", unsafe_allow_html=True)
    
    # --- قسم رسالتنا وفريق العمل ---
