...
with tab4:
    ...
    st.markdown("""
    <div style="background-color: #f8fafc; padding: 20px; border-radius: 10px; border-right: 5px solid #1e3a8a; margin-bottom: 20px;">
        <p style="font-size: 20px; line-height: 1.8; color: #1e293b; text-align: justify; margin: 0;">
            نحن مجموعة من المعلمين المهتمين بطلاب الدمج ونريد لهم حياة أفضل داخل مجتمعنا لذلك نقدم لهم ولمعلمى التربية الخاصة هذة المنصة.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background-color: #ffffff; padding: 15px; border-radius: 10px; text-align: center; border: 1px solid #e2e8f0; margin-top: 20px;">
        <h3 style="color: #0f766e; font-family: 'Cairo', sans-serif; margin: 0;">تم الابتكار والتطوير والبرمجة بواسطة ولاء مقدام</h3>
        <p style="color: #64748b; font-size: 16px; margin-top: 5px;">(بدون أى مؤسسات حكومية أو إدارات)</p>
    </div>
    """, unsafe_allow_html=True)
...
with tab5:
    ...
    with lib_tab2:
        ...
        * **المساواة والعدالة:** الفرق بين مساواة الطلاب في المنهج وعدالة تقديم الوسيلة المناسبة لكل إعاقة.
        * **دور معلم غرف المصادر:** كيف يساهم المعلم في سد الفجوة بين المنهج وقدرات الطالب المدمج في المدارس المصرية.
        * **أهمية الدمج المجتمعي:** لماذا الدمج المدرسي هو الخطوة الأولى لبيئة سوية تتقبل الاختلاف.

        ---
        ### 💡 أهم استراتيجيات تدريس طلاب الدمج ودورها
